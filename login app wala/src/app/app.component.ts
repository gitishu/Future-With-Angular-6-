...
//interface hamesha all decorators ke uper ayanege hamesha
...
export class AppComponent {//export the class by the version of the angular  6 
  ...
  ngOnInit(){
    ...
    // The ngOnInit lifecycle hook is a guarantee that your bindings are readily available.
      ...
      .subscribe(
      data =>{//this subscription is an operator of rxjs ..
    ...
    error =>{
      ...
      //for error handling kuch bhi console log karva do yha pe 
      // httperor response bhi yhi karlo 
    }
